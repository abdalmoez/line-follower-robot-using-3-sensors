...
void rotateLeft(){
  analogWrite(motorRightForward,motorRightPWM-10);
  analogWrite(motorRightBackward,0);
  analogWrite(motorLeftForward,0);
  analogWrite(motorLeftBackward,motorLeftPWM-10);
}
...
void rotateRight(){
  analogWrite(motorRightForward,0);
  analogWrite(motorRightBackward,motorRightPWM-10);
  analogWrite(motorLeftForward,motorLeftPWM-10);
  analogWrite(motorLeftBackward,0);
}
